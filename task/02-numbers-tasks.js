...
function getLastDigit(value) {
     return Number(value.toString().slice(-1)); //Метод slice() возвращает новый массив, содержащий копию части исходного массива.
}
...
a=a*10;
   ...
   return ((Math.round(num / a) *a)); //поделили округлили домножили-все просто
}
